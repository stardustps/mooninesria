...
Mooninesria is a small KernelSU WebUI module for kernels that expose the Lucreticus CPUFreq governors and optional Mali or MediaTek boost parameters.
...
The WebUI requires KernelSU’s WebUI `exec` API and the module path `/data/adb/modules/mooninesria`. It does not require a kernel build.
